...
import br.embrapa.scaffold.view.fragments.ItensFavoritesFragment;
import br.embrapa.scaffold.view.fragments.ItensFragment;
...
public class MainNavigationDrawerActivity extends AppCompatActivity
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_itens) {
            ...
            fragment = new ItensFavoritesFragment();
            ...
            Util.startIntent(MainNavigationDrawerActivity.this,new AboutActivity());
            overridePendingTransition(R.anim.push_left_in, R.anim.push_left_out);
